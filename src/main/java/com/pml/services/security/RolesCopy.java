...
@XmlRootElement(name = "rolesCopy", namespace = "security.services.pml.com")
public class RolesCopy
    extends BaseXmlObject
{

    @XmlElement(name = "role", namespace = "security.services.pml.com")
    ...
    public RolesCopy withRoles(String... values) {
        if (values!= null) {
    ...
    public RolesCopy withRoles(Collection<String> values) {
        if (values!= null) {
