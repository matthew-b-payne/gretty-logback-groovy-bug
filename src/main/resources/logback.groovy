...
logger("com.pml.website.framework", ${log_level}, ["framework"])
logger("com.pennmutual.services", ${log_level}, ["service"])
logger("org.glassfish.jersey", ${log_level}, ["service"])
logger("com.pennmutual.services.client.dao.impl", ${log_level}, ["orm"])
logger("org.jongo", ${log_level}, ["orm"])
logger("java.sql", ${log_level}, ["orm"])
logger("org.springframework", ${log_level}, ["service"])
logger("org.apache.commons.digester", ${log_level}, ["service"])
